...
Genera una lista llamada multiplos que contenga los múltiplos de numero en el rango 1 a 100
(ambos incluidos) utilizando la conversión de un range a list con un paso:
